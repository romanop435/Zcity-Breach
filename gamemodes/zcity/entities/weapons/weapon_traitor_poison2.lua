...
if SERVER then
	hook.Remove("PlayerUse","otravleno_dibil!!!",function(ply,ent)
    ...
    hook.Remove("Org Clear", "RemovePoison2", function(org)
        org.poison2 = nil
		org.poison2notificate = nil
    end)

	hook.Remove("Org Think", "poison2",function(owner, org, timeValue)
