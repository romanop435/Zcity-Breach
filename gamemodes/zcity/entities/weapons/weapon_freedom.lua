...
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_ins2/w_codol_freedom.mdl"
SWEP.WorldModelFake = "models/weapons/tfa_ins2/c_codol_freedom.mdl" -- Контент инсурги https://steamcommunity.com/sharedfiles/filedetails/?id=3437590840 
--uncomment for funny
--а еще надо настраивать заново zoompos
SWEP.FakePos = Vector(3.5, 2.5, 6.5)
...
SWEP.InvIcon = Material( "nextoren/gui/new_icons/weapons/arx.png" )
SWEP.Desc = "Убойное оружие неизвестного происхождения"

SWEP.CanEpicRun = false
SWEP.EpicRunPos = Vector(2,12,5)

SWEP.FakeReloadSounds = {
	[0.25] = "weapons/tfa_ins2/codol_freedom/mk18_magrelease.wav",
	[0.45] = "weapons/tfa_ins2/codol_freedom/mk18_magout.wav",
	[0.69] = "weapons/tfa_ins2/codol_freedom/mk18_magin.wav",
...
SWEP.Primary.Sound = {"weapons/tfa_ins2/codol_freedom/freedom_shoot_01.wav", 75, 90, 100, 2}
SWEP.Primary.SoundEmpty = {"zcitysnd/sound/weapons/ak74/handling/ak74_empty.wav", 75, 105, 110, CHAN_WEAPON, 2}
SWEP.DistSound = "zcitysnd/sound/weapons/mk18/mk18_dist.wav"
SWEP.Primary.Wait = 0.113
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(-9, -1.34, 6.0141)
...
SWEP.PPSMuzzleEffect = "blue_weapon_muzzle_flash"
SWEP.WeaponEyeAngles = Angle(0,0,0.002)

SWEP.attPos = Vector(25.8, 11.1, 25)
...
SWEP.ReloadAnimWepAng = {
	Angle(0,0,0),       -- Начало перезарядки (ровно)
	Angle(-15,25,-15),  -- Оружие дергается вверх и вправо (камера дернется за ним)
	Angle(5,28,-25),    -- Оружие опускается (камера клюнет вниз)
	Angle(1,25,-21),    -- Вставляется магазин (небольшая тряска)
	Angle(0,0,0),       -- Конец перезарядки (возврат в ровное положение)
}
