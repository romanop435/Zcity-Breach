...
if CLIENT then
    SWEP.InvIcon = Material("nextoren/gui/new_icons/pnv_green.png")
    SWEP.IconOverride = "nextoren/gui/new_icons/pnv_green.png"
end

SWEP.HoldType = "normal"
SWEP.ViewModel = ""
SWEP.WorldModel = "models/imperator/items/nightvision/w_night_vision_green.mdl"
SWEP.WorldModelReal = "models/imperator/items/nightvision/v_night_vision_green.mdl"
...
function SWEP:ApplyNVG()
    ...
    if owner:Alive() then
        ...
        if not banned_models[NormalizePath(owner:GetModel())] then
            Bonemerge("models/imperator/items/nightvision/bonemerge_nvg_forface_green.mdl", owner)
