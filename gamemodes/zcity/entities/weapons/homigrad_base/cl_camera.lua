...
function SWEP:Camera(eyePos, eyeAng, view, vellen, ply)
	...
	-- Ученый: руки трясутся всегда немного, а от страха (во время стрельбы) ОЧЕНЬ сильно
	if ply.GTeam and ply:GTeam() == TEAM_SCI then
		k4 = k4 + ((organism.fear or 0) * 0.03) + 0.015 
	end
