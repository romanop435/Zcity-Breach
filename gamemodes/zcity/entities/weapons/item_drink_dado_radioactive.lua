...
if CLIENT then
    SWEP.InvIcon = Material("nextoren/gui/new_icons/scp/scp3238_rad.png")
    SWEP.IconOverride = "nextoren/gui/new_icons/scp/scp3238_rad.png"
    SWEP.red = "SCP"
...
function SWEP:OnRemove()
    ...
    timer.Remove("DadoPunch_" .. wepID)
    timer.Remove("DadoDrink_" .. wepID)
end
...
function SWEP:PrimaryAttack()
    ...
    timer.Create("DadoPunch_" .. wepID, 0.5, 1, function()
    ...
    timer.Create("DadoDrink_" .. wepID, 1.5, 1, function()
        ...
        if SERVER then
            ...
            if owner.CompleteAchievement then
                owner:CompleteAchievement("radioactive")
            end
            ...
            if owner.organism then
                ...
                if hg and hg.organism and hg.organism.RadDamage then
                    hg.organism.RadDamage(owner.organism, 10, dmgInfo)
                end
            end
        end
    end)
