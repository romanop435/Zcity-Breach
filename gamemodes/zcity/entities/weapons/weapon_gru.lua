...
SWEP.PrintName = "Странный прибор"
...
if ( CLIENT ) then
	...
	SWEP.InvIcon = Material( "nextoren/gui/new_icons/gru_rph.png" )

end

SWEP.ViewModel = Model("models/weapons/c_bugbait.mdl")
SWEP.WorldModel = Model("models/cultist/items/uiu_agent_whgrenade/grenade.mdl")
...
SWEP.Config = {
	...
	holdType = "slam",
	viewModel = {
		model = "models/cultist/items/uiu_agent_whgrenade/grenade.mdl",
