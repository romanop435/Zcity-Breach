if SERVER then
	...
	function meta:rtxappend( col, str )
		...
		net.Start("rtxappend")
			...
			net.WriteString(tostring(str or ""))
		net.Send(self)
	end	
	...
	net.Receive( "ScreengrabRequest", function( _, ply )
		...
		for k, v in next, player.GetAll() do
			if v.isgrabbing and v ~= ply then
				ply:rtxappend( sg.red, "Error: " .. v:Name() .. " is screengrabbing " .. tostring(v.sg) .. ". To reduce server stress, only one screengrab can be performed at once." )
				return
			end
		end
